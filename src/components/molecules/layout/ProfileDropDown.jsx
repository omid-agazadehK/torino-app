...
function ProfileDropDown({ userTag, setIsProfileDropDown }) {
  ...
  return (
    <div
      ref={ref}
      className="absolute top-full -right-2 flex h-fit w-40 flex-col overflow-hidden rounded-xl border border-black/20 bg-white md:right-1/2 md:translate-x-1/2 lg:w-62"
    >
