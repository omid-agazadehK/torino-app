function Icons({ className = "", name, onclick = null }) {
  switch (name) {
    ...
    case "suv":
      return (
        <svg version="1.1" viewBox="0 0 260 140" className={className}>
          <path
            d="M246,90.011V59.995c0-5.523-4.48-9.995-10-9.995h-50L156.97,6.416C155.11,3.634,152.34,2,149,2H28
      ...
      return (
        <svg fill="currentcolor" viewBox="0 0 512 512" className={className}>
          <g>
            <g>
              <path
                d="M123.733,298.667c-21.171,0-38.4,17.229-38.4,38.4s17.229,38.4,38.4,38.4s38.4-17.229,38.4-38.4
          ...
          <g>
            <g>
              <path
                d="M503.467,324.267c0-187.733-38.536-187.733-51.2-187.733h-256c-61.15,0-122.47,15.795-142.549,36.617
    ...
    case "cross-empty":
      return (
        <svg fill="currentcolor" className={className} viewBox="0 0 92 92">
          <path
